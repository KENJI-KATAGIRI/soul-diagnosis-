...
from diagnosis_email import is_diagnosis_result_email_enabled, send_diagnosis_result_email
from followup_email import is_followup_email_enabled, send_followup_email
